...
public class Mutation
{
    ...
    public async Task<SyncResult> SyncShopifyData([Service] IShopifyService shopifyService, [Service] ApplicationDbContext context, [Service] ILogger<Mutation> logger)
    {
                ...
                if (existingOrder == null)
                {
                    ...
                    foreach (var li in so.LineItems)
                    {
                        ...
                        order.OrderItems.Add(new OrderItem
                        {
                            ...
                            ProductTitle = li.Title ?? string.Empty
                        });
                    }
        ...
        {
            logger.LogError(ex, "Shopify sync failed.");
