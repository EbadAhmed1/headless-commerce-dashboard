...
const initialNotifications: Notification[] = [
  {
    ...
    message: 'Order #1042 has been placed by a customer for RS 234.50.',
    time: '5 minutes ago',
    read: false,
  },
  {
        ...
        {notifications.length === 0 ? (
          ...
          <div className="space-y-3">
            {notifications.map((n) => (
              <Card
                key={n.id}
                className={`transition-colors border-border/70 bg-card/90 shadow-sm ${!n.read ? 'border-primary/30 bg-primary/5' : ''}`}
              >
